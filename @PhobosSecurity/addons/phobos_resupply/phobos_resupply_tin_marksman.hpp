class phobos_resupply_tin_marksman : phobos_resupply_box_base
{
    displayName = "[BT] Ammo Tin (Marksman)";
    author = "Brandersons";
    scope = 2;
    scopeCurator = 2;
    ...
    {
        class xx_phobos_greenmag_large_40rnd
        {
            name = "phobos_greenmag_large_40rnd";
            count = 4;
        };
