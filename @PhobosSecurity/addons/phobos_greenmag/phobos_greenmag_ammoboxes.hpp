...
class phobos_greenmag_large_1rnd: greenmag_core_1Rnd
{
    displayName="[Phobos] 1 Round of large Ammo";
    picture="\z\greenmag\addons\main\data\127mm.paa";
    scope=2;
    scopeArsenal=2;
    scopeCurator=2;
...
class phobos_greenmag_large_60rnd: greenmag_core_60Rnd
{
    ...
    scopeArsenal=2;
    scopeCurator=2;
};class phobos_greenmag_pistol_1rnd: greenmag_core_1Rnd
{
    displayName="[Phobos] 1 Round of Pistol Ammo";
    picture="\z\greenmag\addons\main\data\127mm.paa";
    scope=2;
    scopeArsenal=2;
    scopeCurator=2;
